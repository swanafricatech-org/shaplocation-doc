        ...
        <header class="docs-header">
            ...
            <section class="docs-intro">
                <p>
                    ...
                    Suivez ces étapes simples pour vous inscrire et commencer à utiliser notre plateforme.
                </p>
            </section>
        </header>
        <section class="docs-section">
            <h2 class="vt-doc pad-top">Comment s'inscrire ?</h2>
            <p>Pour s'inscrire sur ShapLocation, vous avez deux (02) modes d'inscription :</p>
            <ul>
                <li><a href="#ins-mode-1" class="link-primary">Inscription par formulaire</a></li>
                <li><a href="#ins-mode-2" class="link-primary">Inscription par Google</a></li>
            </ul>
            <p>Voici comment procéder pour chaque méthode :</p>
            ...
            <div class="row mb-3 mt-5" id="ins-mode-1">
                ...
                <div class="col-md-6">
                    <ol>
                        ...
                        <li>Allez sur la page de connexion en cliquant <a class="link-primary"
                                href="https://shaplocation.com/auth/signin" target="_blank">ici</a></li>
                        ...
                        <li>
                            ...
                            <ul>
                                <li>Nom et prénom : Entrez votre prénom et nom.</li>
                                <li>Numéro de téléphone : Indiquez un numéro de téléphone actif pour la vérification et
                                    les notifications.</li>
                                <li>
                                    Types de compte : Sélectionnez le type de compte que vous voulez créer (Utilisateur,
                                    Marchand, Propriétaire).<br />
                                    <span class="fw-medium">NB: Le démarcheur est un marchand.</span>
                                </li>
                                <li>
                                    Mot de passe : Choisissez un mot de passe sécurisé et mémorable. <br />
                                    <span class="fw-medium">Note : Le mot de passe doit contenir des lettres majuscules,
                                        minuscules, des chiffres et des symboles.</span>
                                </li>
                                <li>Confirmation du mot de passe : Saisissez à nouveau le mot de passe pour
                                    confirmation.</li>
                            </ul>
                        </li>
            ...
            <div class="row mb-3 mt-5">
                <div class="col-md-6 d-flex  align-items-center flex-column gap-4">
                    ...
                    <p>Lorsque vous choisissez "Marchand" ou "Propriétaire" comme type de compte, des étapes
                        supplémentaires sont nécessaires :</p>
                    <ol start="7">
                                ...
                                <li>
                                    ...
                                    <ol>
                                        ...
                                        <li>Entrez votre Identifiant Fiscal Unique (IFU) et choisissez le type de pièce
                                            ...
                                            (CNI)).</li>
                                        <li>Saisissez le numéro de la pièce et cliquez sur le bouton "Suivant".</li>
                                        <li>Vous serez redirigé vers une page où vous devez ajouter les documents et
                                            pièces justificatives (le document IFU et celui de la carte).</li>
                                        <li>Cliquez sur "Suivant". Les informations seront automatiquement enregistrées
                                            et vous serez redirigé vers la page d'accueil.</li>
                                    </ol>
                                </li>
                                <li>
                                    <span class="fw-medium">Entreprise :</span>
                                    <ol>
                                        <li>Sélectionnez "Entreprise" et un formulaire apparaîtra en bas.</li>
                                        <li>Entrez les informations suivantes : Identifiant Fiscal Unique (IFU), Nom,
                                            Extrait du Registre de Commerce et de Crédit Mobilier (RCCM), et
                                            Description.</li>
                                        <li>Cliquez sur le bouton "Suivant".</li>
                                        <li>Vous serez redirigé vers une page avec un formulaire demandant des
                                            informations supplémentaires : Pays, Départements, Communes,
                                            Arrondissements, Quartiers, et Adresse.</li>
                                        <li>Remplissez le formulaire et cliquez sur "Suivant".</li>
                                        <li>Vous serez redirigé vers une page où vous devez sélectionner les types
                                            d'articles que vous souhaitez publier sur ShapLocation.</li>
                                        <li>Sélectionnez les types d'articles et cliquez sur "Suivant".</li>
                                        <li>Vous serez redirigé vers une page où vous devez ajouter les documents et
                                            pièces justificatives (Identifiant Fiscal Unique (IFU) et Extrait du
                                            Registre de Commerce et de Crédit Mobilier (RCCM)).</li>
                                        <li>Ajoutez les documents et cliquez sur "Suivant". Les informations seront
                                            automatiquement enregistrées et vous serez redirigé vers la page d'accueil.
                                        </li>
                                    </ol>
                                </li>
                            </ul>
