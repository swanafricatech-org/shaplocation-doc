    ...
    <article class="docs-article" id="section-2">
        ...
        <section class="docs-section">
            ...
            <ul>
                ...
                <li><a href="#mode-3" class="link-primary">connexion directe par Google</a></li>
            </ul>
            ...
            <div class="row mb-4 mt-5" id="mode-1">
                <div class="col-md-6">
                    ...
                    <ol>
                        ...
                        <li>Cliquez sur l'endroit où c'est écrit le <span class="fw-medium">"Numéro"</span>, vous verrez
            ...
            <div class="row mb-3 mt-5" id="mode-3">
                <div class="col-md-6">
                    ...
                    <ol>
                        ...
                        <li>Cliquez sur l'endroit où c'est écrit <span class="fw-medium">"Email"</span>, vous verrez le
                            bouton "Se connecter avec Google" juste en bas.</li>
